...
public class Konstants
{
	...
	public static final double MINLEVEL = -0.1;
	public static final double MAXLEVEL = 0.1;
	public static final double MINSTEERING= -0.01;
	public static final double MAXSTEERING= 0.01;
